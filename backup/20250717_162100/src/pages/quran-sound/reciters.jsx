    ...
    return (
        <>
            <SeoHead
                ...
                url={`${process.env.NEXT_PUBLIC_BASE_URL}/quran-sound/reciters`}
                ...
                {paginatedReciters.length > 0 ? (
                    <>
                                ...
                                >
                                    <Link href={`/quran-sound/${createSlug(reciter.reciter.en)}`} className={styles.Link}>
                                        <div className={styles.reciterDetails}>
                                            <div className={styles.reciterNumber} title={reciter.id} aria-label={reciter.id}>رقم: {convertToArabicNumerals(reciter.id)}</div>
                        ...
                        <div className={styles.pagination}>
                            ...
                            <span>الصفحة {convertToArabicNumerals(currentPage)}</span>
